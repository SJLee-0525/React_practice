...
function App() {
  ...
  function handleDeleteProject() {
    setProjectState((prevState) => {
      return {
        ...
        selectedProjectId: undefined,
        projects: [
          ...prevState.projects.filter((project) => {
  ...
  if (projectState.currentAction === "nothing-selected") {
    ...
    content = <SelectedProject project={selectedProject} onDelete={handleDeleteProject} tasks={projectState.tasks} onAddTask={handleAddTask} onDeleteTask={handleDeleteTask} />
  }
