              ...
              return (
                <>
                  <li key={task.id} className="flex justify-between items-center">
                    <span>{task.task}</span>
                    <button className="p-1.5 text-sm rounded-md text-red-600 hover:font-bold hover:text-stone-50 hover:bg-red-700 hover:transition-all" onClick={() => onDeleteTask(task.id)}>
                      Clear
                    </button>
                  </li>
